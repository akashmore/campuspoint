...
<html lang="en">
  <head>
    ...
    <link href="login-modal-bootstrap/css/font-awesome.min.css" rel="stylesheet">
    <link href="login-modal-bootstrap/css/style.css" rel="stylesheet">

    <link href="login-modal-bootstrap/css/sticky-footer-navbar.css" rel="stylesheet">

    <script src="login-modal-bootstrap/js/ie.js"></script>
    ...
    <div class="container content">
      	...
      	<div class='row'>
      		<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center'>
      			<a class="btn btn-launch" href="javascript:;" data-toggle="modal" data-target="#loginModal"> Login</a>
      		</div>
      	</div>		
    </div>
	<h2>&nbsp;</h2>
