...
<form action="delete_not.php" method="post" enctype="multipart/form-data">
<br/><br/><br/>
BRANCH&nbsp&nbsp
<select name="branch">
...
<br><br>
<input id="butt" type="submit" name="show1" value="show notices"/>
...
<br><br>
<input id="butt" type="submit" name="show2" value="show notes"/>
