...
if (in_array($_FILES['file_upload']['type'], $types)) 
{
	...
	if(move_uploaded_file($t_name,$dir."/".$audio_name))
	{
		...
		$qur="insert into audio(id,username,author_name,audio_name,path,date,time,showname) values('','$username','$author_name','$audio_name','upload/$name','$date','$time','$showname')";
