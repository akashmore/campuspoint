...
<div class="container">                                       
  ...
  <br>
    ...
    <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
	        <li role="presentation"><a role="menuitem" tabindex="-1" href="cse.html">CSE</a></li>
		  <li role="presentation"><a role="menuitem" tabindex="-1" href="it.html">IT</a></li>
		  <li role="presentation"><a role="menuitem" tabindex="-1" href="mech.html">MECHANICAL</a></li>
		  <li role="presentation"><a role="menuitem" tabindex="-1" href="tronics.html">ELECTRONICS</a></li>
		  <li role="presentation"><a role="menuitem" tabindex="-1" href="trical.html">ELECTRICAL</a></li>
		  <li role="presentation"><a role="menuitem" tabindex="-1" href="civil.html">CIVIL</a></li>
...
<div class="container-fluid">
  ...
  <center><div class="col-sm-12" style="background-color:white;font-family: 'Lobster', cursive;color:green"><h2>--NEWS & ANNOUNCEMENTS--</h2></div></center>
   <br><br>
 ...
 <div class="row">
  ...
  <div class="col-sm-4"></div>
 <div class="col-sm-4"><a href="announcementsit.html"><button type="button" class="btn btn-warning"></i>-ANNOUNCEMENTS-<i class="glyphicon glyphicon-hand-right"></i></button></a></div>
  </div>
  </div>
...
<br><br>
    ...
    <h2 style="color:#ff9800;font-family:'Lobster';font-size:50px">--SY--</h2>
	  <?php 
	  mysql_select_db($database,$php_not_and_announ);
	  $qur1="select path,name from notices where cid='1'";
    ...
    <h2 style="color:#ff9800;font-family:'Lobster';font-size:50px">--TY--</h2>
	  <?php 
	  mysql_select_db($database,$php_not_and_announ);
	  $qur1="select path,name from notices where cid='2'";
	  $res1=mysql_query($qur1);
	  while($row1=mysql_fetch_array($res1))
	  {
	  ...
	  <?php 
	  mysql_select_db($database,$php_not_and_announ);
	  $qur1="select path,name from notices where cid='3'";
	  $res1=mysql_query($qur1);
	  while($row1=mysql_fetch_array($res1))
	  {
