 ...
 <div class="mail-box">
                  ...
                  <aside class="lg-side">
                    <div class="inbox-head">
                          <h3>Your Corner</h3>
                          <form method="post" action="profile_image.php" class="pull-right position">
                      ...
                      <div class="inbox-body">
					    <form name="form" method="post" action="profile_image.php">
                         ...
                         <div class="mail-option">
                            <center> <h3>Gallery Images</h3></center>
						...
						//	$data_qur="select * from gallery where username='".$username."'";
							...
							while($data_row_image=mysql_fetch_array($res_count1))
							{
								?>
                              ...
                              <tr class="">
                                 ...
                                 <td class="inbox-small-cells"><?php echo $data_row_image['showname'];?></td>
                                  <td class="view-message dont-show"><?php echo $data_row_image['category'];?></td>
								   ...
								   <form action="delete_image.php" method="post" name="myform">
									...
									<input type="hidden" name="image" value="<?php echo $data_row_image['image_name']?>"/>
								  </form>
								  
								  
                                  <td class="view-message dont-show"><?php echo $data_row_image['date'];?></td>

                                  <td class="view-message"><?php echo $data_row_image['time'];?></td>
						     </tr>
							 <?php
							}
							?>
