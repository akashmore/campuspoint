...
$data_qur="select * from gallery where username='".$username."'";
...
if(isset($_POST['search_button']))
{
	...
	$count1="select * from gallery where showname like '%".$search_key."%' and username='".$username."'";

    $count2="select * from audio where showname like '%".$search_key."%' and username='".$username."'";

    $count3="select * from video where showname like '%".$search_key."%' and username='".$username."'";
}

$res_count1=mysql_query($count1,$connection);
$num1=mysql_num_rows($res_count1);

$res_count2=mysql_query($count2,$connection);
$num2=mysql_num_rows($res_count2);

$res_count3=mysql_query($count3,$connection);
$num3=mysql_num_rows($res_count3);
 ...
 <div class="mail-box">
                  <aside class="sm-side">
                      <div class="user-head">
                          ...
                          <div class="user-name">
                              <h5><a href="#"><a><?php echo $data_row1['name'];?></h5>
                          </div>
						     ...
						     <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="mysetting" class="modal fade" style="display: none;">
                              <div class="modal-dialog">
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                      <form role="form" class="form-horizontal" method="post" action="auth_update.php" enctype="multipart/form-data">

									  <div class="form-group">
                                                  <label class="col-lg-2 control-label">Username</label>
                                                 <div class="col-lg-10">
                                                      <input type="text" placeholder="" name="username" value="<?php echo $data_row1['username'];?>" id="cc" class="form-control">
                                                  </div>
											  </div>
                                              <div class="form-group">
                                                  <label class="col-lg-2 control-label">Old Password</label>
                                                  <div class="col-lg-10">
                                                      <input type="text"  name="oldpass" id="cc" class="form-control" value="<?php echo $data_row1['password'];?>">
                                                  </div>
                                              </div>
                                              <div class="form-group">
                                              ...
                                              <div class="form-group">
                                                  <div class="col-lg-offset-2 col-lg-10">
                                                      <button class="btn btn-send" type="submit" name="update">Save</button>

                                                      <button class="btn btn-send" type="submit" name="cancel">Cancel</button>
                                                  </div>
                                              </div>
                                          </form>
                                      </div>
                  ...
                  <aside class="lg-side">
                      <div class="inbox-head">
                          <h3>Your Corner</h3>
                          <form method="post" action="profile.php" class="pull-right position">
                         ...
                         <div class="mail-option">
                          ...
                          <table class="table table-inbox table-hover">
							...
							<tr class="unread">
                                  ...
                                  <td class="view-message ">Category</td>
							...
							while($data_row_all=mysql_fetch_array($res_count1))
							{
								?>
                              ...
                              <tr class="">
                                 ...
                                 <td class="inbox-small-cells"><?php echo $data_row_all['showname'];?></td>
                                  <td class="view-message dont-show">Image</td>
								  
								  <form action="delete_image.php" method="post" name="myform">
									<td class="view-message"> <button type="submit" class="btn btn-link" name="yes" ><i class="fa fa-trash-o"></button></td>
									<input type="hidden" name="image" value="<?php echo $data_row_all['image_name']?>"/>
								  </form>
								  
								  <td class="view-message"><?php echo $data_row_all['date'];?></td>
                                  <td class="view-message"><?php echo $data_row_all['time'];?></td>
							...
							?>
							<?php
							while($data_row_all=mysql_fetch_array($res_count2))
							{
								?>
                              ...
                              <tr class="">
                               <td class="inbox-small-cells"><?php echo $data_row_all['showname'];?></td>
                                  <td class="view-message dont-show">Audio</td>
								   <form action="delete_audio.php" method="post" name="myform">
									<td class="view-message"> <button type="submit" class="btn btn-link" name="yes" ><i class="fa fa-trash-o"></button></td>
									<input type="hidden" name="audio" value="<?php echo $data_row_all['audio_name']?>"/>
								  </form>
                                  <td class="view-message"><?php echo $data_row_all['date'];?></td>
                                  <td class="view-message"><?php echo $data_row_all['time'];?></td>
							...
							?>
							<?php
							while($data_row_all=mysql_fetch_array($res_count3))
							{
								?>
                              ...
                              <tr class="">
                               <td class="inbox-small-cells"><?php echo $data_row_all['showname'];?></td>
                                  <td class="view-message dont-show">Video</td>
								   <form action="delete_video.php" method="post" name="myform">
									<td class="view-message"> <button type="submit" class="btn btn-link" name="yes" ><i class="fa fa-trash-o"></button></td>
									<input type="hidden" name="video" value="<?php echo $data_row_all['video_name']?>"/>
								  </form>
                                  <td class="view-message"><?php echo $data_row_all['date'];?></td>
                                  <td class="view-message"><?php echo $data_row_all['time'];?></td>
