...
$data_qur="select * from video where username='".$username."'";
 ...
 <div class="mail-box">
                  ...
                  <aside class="lg-side">
                      <div class="inbox-head">
                          <h3>Your Corner</h3>
                          <form method="post" action="profile_video.php" class="pull-right position">
                      ...
                      <div class="inbox-body">
					    <form name="form" method="post" action="profile.php">
                         ...
                         <div class="mail-option">
                            <center> <h3>Video files</h3></center>
                          ...
                          <table class="table table-inbox table-hover">
							...
							while($data_row_video=mysql_fetch_array($res_count3))
							{
								?>
                              ...
                              <tr class="">
                                 ...
                                 <td class="inbox-small-cells"><?php echo $data_row_video['showname'];?></td>
                                  <td class="view-message dont-show"><?php echo $data_row_video['category'];?></td>
								  ...
								  <form action="delete_video.php" method="post" name="myform">
									...
									<input type="hidden" name="video" value="<?php echo $data_row_video['video_name']?>"/>
								  </form>
								  

                                  <td class="view-message dont-show"><?php echo $data_row_video['date'];?></td>
                                  <td class="view-message dont-show"><?php echo $data_row_video['time'];?></td>
