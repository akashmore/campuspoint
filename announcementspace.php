...
<div class="container-fluid">
  <div class="row">
   <center><div class="row"> <center><div class="col-sm-12" style="background-color:white;font-family: 'Lobster', cursive;color:green"><h2>-- PACE --</h2></div></center>
 ...
 <div class="row">
  ...
  <div class="col-sm-4"></div>
 <div class="col-sm-4"><a href="PACE.php"><button type="button" class="btn btn-warning"></i><i class="glyphicon glyphicon-hand-left"></i> NOTICES </button></a></div>
  </div>
  </div>
...
<br><br>
    ...
    <h2 style="color:#ff9800;font-family:'Lobster';font-size:50px">--SY--</h2>
	  <?php 
	  mysql_select_db($database,$php_not_and_announ);
	  $qur1="select path,name from notices where cid='1' and branch='PACE' and belong=0";
    ...
    <h2 style="color:#ff9800;font-family:'Lobster';font-size:50px">--TY--</h2>
	  <?php 
	  mysql_select_db($database,$php_not_and_announ);
	  $qur1="select path,name from notices where cid='2' and branch='PACE' and belong=0";
	  $res1=mysql_query($qur1);
	   $num=mysql_num_rows($res1);
	  ...
	  <?php 
	  mysql_select_db($database,$php_not_and_announ);
	  $qur1="select path,name from notices where cid='3' and branch='PACE' and belong=0";
	  $res1=mysql_query($qur1);
	   $num=mysql_num_rows($res1);
