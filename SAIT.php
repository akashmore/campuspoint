...
<br><br>
    ...
    <h2 style="color:#ff9800;font-family:'Lobster';font-size:50px">--SY--</h2>
	  <?php 
	  mysql_select_db($database,$php_not_and_announ);
	  $qur1="select path,name from notices where cid='1' and branch='SAIT' and belong=1";
    ...
    <h2 style="color:#ff9800;font-family:'Lobster';font-size:50px">--TY--</h2>
	  <?php 
	  mysql_select_db($database,$php_not_and_announ);
	  $qur1="select path,name from notices where cid='2' and branch='SAIT' and belong=1";
	  $res1=mysql_query($qur1);
	   $num=mysql_num_rows($res1);
	  ...
	  <?php 
	  mysql_select_db($database,$php_not_and_announ);
	  $qur1="select path,name from notices where cid='3' and branch='SAIT' and belong=1";
	  $res1=mysql_query($qur1);
	   $num=mysql_num_rows($res1);
