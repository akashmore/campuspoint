...
var vplp_settings = {
	...
	/*layout100perc: layout size 100%, hide fullscreen button in non supported browsers (IE currently) since it doesnt do anything in 100% percent layout */
	layout100perc:true
};
